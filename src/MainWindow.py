...
class MainWindow(QMainWindow):
    ...
    def __background_white_enabled_action(self)-> None:
        self.data.background.white.enabled = self.widget.background.white.color_enable.isChecked()
        return
    
    def __background_white_min_action(self)-> None:
        self.data.background.white.min_ = self.widget.background.white.color_min.input_.text()
        return
    
    def __background_white_max_action(self)-> None:
        self.data.background.white.max_ = self.widget.background.white.color_max.input_.text()
        return
    
    def __background_white_steps_action(self)-> None:
        self.data.background.white.steps = self.widget.background.white.color_steps.input_.text()
        return 
              
    def __background_black_enabled_action(self)-> None:
        self.data.background.black.enabled = self.widget.background.black.color_enable.isChecked()
        return
              
    def __background_black_min_action(self)-> None:
        self.data.background.black.min_ = self.widget.background.black.color_min.input_.text()
        return
              
    def __background_black_max_action(self)-> None:
        self.data.background.black.max_ = self.widget.background.black.color_max.input_.text()
        return
              
    def __background_black_steps_action(self)-> None:
        self.data.background.black.steps = self.widget.background.black.color_steps.input_.text()
        return
              
    def __background_red_enabled_action(self)-> None:
        self.data.background.red.enabled = self.widget.background.red.color_enable.isChecked()
        return
              
    def __background_red_min_action(self)-> None:
        self.data.background.red.min_ = self.widget.background.red.color_min.input_.text()
        return
              
    def __background_red_max_action(self)-> None:
        self.data.background.red.max_ = self.widget.background.red.color_max.input_.text()
        return
              
    def __background_red_steps_action(self)-> None:
        self.data.background.red.steps = self.widget.background.red.color_steps.input_.text()
        return
              
    def __background_yellow_enabled_action(self)-> None:
        self.data.background.yellow.enabled = self.widget.background.yellow.color_enable.isChecked()
        return
              
    def __background_yellow_min_action(self)-> None:
        self.data.background.yellow.min_ = self.widget.background.yellow.color_min.input_.text()
        return
              
    def __background_yellow_max_action(self)-> None:
        self.data.background.yellow.max_ = self.widget.background.yellow.color_max.input_.text()
        return
              
    def __background_yellow_steps_action(self)-> None:
        self.data.background.yellow.steps = self.widget.background.yellow.color_steps.input_.text()
        return
              
    def __background_green_enabled_action(self)-> None:
        self.data.background.green.enabled = self.widget.background.green.color_enable.isChecked()
        return
              
    def __background_green_min_action(self)-> None:
        self.data.background.green.min_ = self.widget.background.green.color_min.input_.text()
        return
              
    def __background_green_max_action(self)-> None:
        self.data.background.green.max_ = self.widget.background.green.color_max.input_.text()
        return
              
    def __background_green_steps_action(self)-> None:
        self.data.background.green.steps = self.widget.background.green.color_steps.input_.text()
        return
              
    def __background_teal_enabled_action(self)-> None:
        self.data.background.teal.enabled = self.widget.background.teal.color_enable.isChecked()
        return
              
    def __background_teal_min_action(self)-> None:
        self.data.background.teal.min_ = self.widget.background.teal.color_min.input_.text()
        return
              
    def __background_teal_max_action(self)-> None:
        self.data.background.teal.max_ = self.widget.background.teal.color_max.input_.text()
        return
              
    def __background_teal_steps_action(self)-> None:
        self.data.background.teal.steps = self.widget.background.teal.color_steps.input_.text()
        return
              
    def __background_blue_enabled_action(self)-> None:
        self.data.background.blue.enabled = self.widget.background.blue.color_enable.isChecked()
        return
              
    def __background_blue_min_action(self)-> None:
        self.data.background.blue.min_ = self.widget.background.blue.color_min.input_.text()
        return
              
    def __background_blue_max_action(self)-> None:
        self.data.background.blue.max_ = self.widget.background.blue.color_max.input_.text()
        return
              
    def __background_blue_steps_action(self)-> None:
        self.data.background.blue.steps = self.widget.background.blue.color_steps.input_.text()
        return
              
    def __background_purple_enabled_action(self)-> None:
        self.data.background.purple.enabled = self.widget.background.purple.color_enable.isChecked()
        return
              
    def __background_purple_min_action(self)-> None:
        self.data.background.purple.min_ = self.widget.background.purple.color_min.input_.text()
        return
              
    def __background_purple_max_action(self)-> None:
        self.data.background.purple.max_ = self.widget.background.purple.color_max.input_.text()
        return
              
    def __background_purple_steps_action(self)-> None:
        self.data.background.purple.steps = self.widget.background.purple.color_steps.input_.text()
        return
              
    def __foreground_white_enabled_action(self)-> None:
        self.data.foreground.white.enabled = self.widget.foreground.white.color_enable.isChecked()
        return
              
    def __foreground_white_min_action(self)-> None:
        self.data.foreground.white.min_ = self.widget.foreground.white.color_min.input_.text()
        return
              
    def __foreground_white_max_action(self)-> None:
        self.data.foreground.white.max_ = self.widget.foreground.white.color_max.input_.text()
        return
              
    def __foreground_white_steps_action(self)-> None:
        self.data.foreground.white.steps = self.widget.foreground.white.color_steps.input_.text()
        return
              
    def __foreground_black_enabled_action(self)-> None:
        self.data.foreground.black.enabled = self.widget.foreground.black.color_enable.isChecked()
        return
              
    def __foreground_black_min_action(self)-> None:
        self.data.foreground.black.min_ = self.widget.foreground.black.color_min.input_.text()
        return
              
    def __foreground_black_max_action(self)-> None:
        self.data.foreground.black.max_ = self.widget.foreground.black.color_max.input_.text()
        return
              
    def __foreground_black_steps_action(self)-> None:
        self.data.foreground.black.steps = self.widget.foreground.black.color_steps.input_.text()
        return
              
    def __foreground_red_enabled_action(self)-> None:
        self.data.foreground.red.enabled = self.widget.foreground.red.color_enable.isChecked()
        return
              
    def __foreground_red_min_action(self)-> None:
        self.data.foreground.red.min_ = self.widget.foreground.red.color_min.input_.text()
        return
              
    def __foreground_red_max_action(self)-> None:
        self.data.foreground.red.max_ = self.widget.foreground.red.color_max.input_.text()
        return
              
    def __foreground_red_steps_action(self)-> None:
        self.data.foreground.red.steps = self.widget.foreground.red.color_steps.input_.text()
        return
              
    def __foreground_yellow_enabled_action(self)-> None:
        self.data.foreground.yellow.enabled = self.widget.foreground.yellow.color_enable.isChecked()
        return
              
    def __foreground_yellow_min_action(self)-> None:
        self.data.foreground.yellow.min_ = self.widget.foreground.yellow.color_min.input_.text()
        return
              
    def __foreground_yellow_max_action(self)-> None:
        self.data.foreground.yellow.max_ = self.widget.foreground.yellow.color_max.input_.text()
        return
              
    def __foreground_yellow_steps_action(self)-> None:
        self.data.foreground.yellow.steps = self.widget.foreground.yellow.color_steps.input_.text()
        return
              
    def __foreground_green_enabled_action(self)-> None:
        self.data.foreground.green.enabled = self.widget.foreground.green.color_enable.isChecked()
        return
              
    def __foreground_green_min_action(self)-> None:
        self.data.foreground.green.min_ = self.widget.foreground.green.color_min.input_.text()
        return
              
    def __foreground_green_max_action(self)-> None:
        self.data.foreground.green.max_ = self.widget.foreground.green.color_max.input_.text()
        return
              
    def __foreground_green_steps_action(self)-> None:
        self.data.foreground.green.steps = self.widget.foreground.green.color_steps.input_.text()
        return
              
    def __foreground_teal_enabled_action(self)-> None:
        self.data.foreground.teal.enabled = self.widget.foreground.teal.color_enable.isChecked()
        return
              
    def __foreground_teal_min_action(self)-> None:
        self.data.foreground.teal.min_ = self.widget.foreground.teal.color_min.input_.text()
        return
              
    def __foreground_teal_max_action(self)-> None:
        self.data.foreground.teal.max_ = self.widget.foreground.teal.color_max.input_.text()
        return
              
    def __foreground_teal_steps_action(self)-> None:
        self.data.foreground.teal.steps = self.widget.foreground.teal.color_steps.input_.text()
        return
              
    def __foreground_blue_enabled_action(self)-> None:
        self.data.foreground.blue.enabled = self.widget.foreground.blue.color_enable.isChecked()
        return
              
    def __foreground_blue_min_action(self)-> None:
        self.data.foreground.blue.min_ = self.widget.foreground.blue.color_min.input_.text()
        return
              
    def __foreground_blue_max_action(self)-> None:
        self.data.foreground.blue.max_ = self.widget.foreground.blue.color_max.input_.text()
        return
              
    def __foreground_blue_steps_action(self)-> None:
        self.data.foreground.blue.steps = self.widget.foreground.blue.color_steps.input_.text()
        return
              
    def __foreground_purple_enabled_action(self)-> None:
        self.data.foreground.purple.enabled = self.widget.foreground.purple.color_enable.isChecked()
        return
              
    def __foreground_purple_min_action(self)-> None:
        self.data.foreground.purple.min_ = self.widget.foreground.purple.color_min.input_.text()
        return
              
    def __foreground_purple_max_action(self)-> None:
        self.data.foreground.purple.max_ = self.widget.foreground.purple.color_max.input_.text()
        return
